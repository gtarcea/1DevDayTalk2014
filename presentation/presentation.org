...
** Where to get the app
    - I've set up a Github repo that contains the working app
      ...
      - The presentation is also available here (org, PDF and html formats)
...
- The large number of standard libraries for each means you can easily
  create a reasonably complex application
...
- Hopefully this talk and the example app at [[https://github.com/gtarcea/1DevDayTalk2014]]
